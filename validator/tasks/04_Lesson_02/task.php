...
//-------------------------------------------------->
$cls_Task->s_title = "Середнє арифметичне";
$cls_Task->s_id = "04_Lesson_02";
$cls_Task->s_description = "робота з цілими та дробовими числами";

$cls_Task->_add_step("<b>Опис:</b> <i>даний додаток дозволяє обчислити середнє арифметично двох введених чисел.</i>");
$cls_Task->_add_step("Створити проект <b>task_2</b> у рішенні <b>Lesson_04</b>");
