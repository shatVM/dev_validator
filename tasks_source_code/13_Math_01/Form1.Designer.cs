namespace Circle
{
    ...
    "грамування обчислювальних проектів.";
            ...
            this.lb_Author.Location = new System.Drawing.Point(-3, 580);
            this.lb_Author.Name = "lb_Author";
            this.lb_Author.Size = new System.Drawing.Size(661, 20);
            this.lb_Author.TabIndex = 20;
            this.lb_Author.Text = "Автор: учень 12-В групи Наукового ліцею Житомирської політехніки, Шатківський В.М" +
    ". ";
            // 
            // textBox1
            // 
